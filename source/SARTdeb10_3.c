						...
						{	
							diferencia=0;
								for(cont4=0; cont4 < NumPix; cont4++)
								{
										...
										diferencia+=(b[n_gamm[cont2][cont3].ang[cont]][cont4]-cant)*((coe[n_gamm[cont2][cont3].ang[cont]][cont4].a[cont2][cont3]))/(betar[n_gamm[cont2][cont3].ang[cont]][cont4]); /*Alguno de estos es un producto por 0 ¿?*/
